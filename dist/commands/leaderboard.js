...
exports.data = new builders_1.SlashCommandBuilder()
    ...
    .setRequired(true)
    .addChoices({ name: '가위바위보', value: 'rps' }, { name: '틱택토', value: 'tictactoe' }, { name: '블랙잭', value: 'blackjack' }, { name: '숫자야구', value: 'numberbaseball' }, { name: '끝말잇기', value: 'wordrelay' }, { name: '초성퀴즈', value: 'quiz' }, { name: '타자배틀', value: 'typing' }, { name: '낚시도감', value: 'fishing' }));
async function execute(interaction) {
    ...
    switch (game) {
        ...
        case 'typing':
            ...
            break;
        case 'fishing':
            const stats = (0, stats_1.readStats)();
            const fishingLeaderboard = Object.entries(stats)
                ...
                .slice(0, 10);
            const fishingEmbed = new discord_js_1.EmbedBuilder()
                .setTitle('🎣 낚시도감 순위표')
    ...
    if (game === 'points') {
        ...
        const pointsLeaderboard = Object.entries(stats)
            ...
            .sort((a, b) => b.value - a.value)
            .slice(0, 10);
        const pointsEmbed = new discord_js_1.EmbedBuilder()
            .setTitle(title)
    ...
    const leaderboard = (0, stats_1.getLeaderboard)(game, field, 10);
